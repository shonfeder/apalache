...
/**
  ...
  * This snapshot is quite simple: It saves the depts of the rewriter stack as well
  * as the types of the type finder.
  *
  * @author Igor Konnov
  */
class IncrementalSnapshot(var rewriterLevel: Int, varTypes: Map[String, CellT]) {
}
