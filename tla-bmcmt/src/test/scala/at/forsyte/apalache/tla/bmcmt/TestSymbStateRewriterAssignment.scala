...
class TestSymbStateRewriterAssignment extends RewriterBase with TestingPredefs {
  ...
  test("""SE-IN-ASSIGN1(set): \E t \in {{1, 2}, {2, 3}}: x' \in {t} ~~> TRUE and [x -> $C$k]""") {
    ...
    val eqState12 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eq12))
    ...
    val eqState23 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eq23))
    ...
    val eqState13 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eq13))
  ...
  test("""SE-IN-ASSIGN1(set): \E t \in {{1, 2}, {1+1, 2, 3}} \ {{2, 3}}: x' \in {t} ~~> TRUE and [x -> $C$k]""") {
    ...
    val inState23 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(in23))
  ...
  test("""SE-IN-ASSIGN1(set): \E t \in SUBSET {1, 2}: x' \in {t} ~~> TRUE and [x -> $C$k]""") {
    ...
    val eqState1 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eq1))
    ...
    val eqState2 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eq2))
    ...
    val eqStateEmpty = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eqEmpty))
  ...
  test("""SE-IN-ASSIGN1(fun): \E t \in {[x \in BOOLEAN |-> 0], [x2 \in BOOLEAN |-> 1]}: x' \in {t} ~~> TRUE""") {
    ...
    val eqStateFun0 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eqFun0))
    ...
    val eqStateFun1 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eqFun1))
    ...
    val eqStateFun2 = rewriter.rewriteUntilDone(nextState.setTheory(CellTheory()).setRex(eqFun2))
